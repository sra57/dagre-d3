...
function adjustEdgePositionsForCategories(g) {
  g.edges().forEach(function (e) {
    ...
    // Reposition the first point of the edge so it comes out of the assigned
    // category in the source node.
    repositionFirstPointInEdge(g, e);

    if (e.v === e.w) {
      // Redraw the rest of the recursive edge (loop).
